...
![首页 · 暗色「机身」](docs/screenshots/home-dark.png)

## 功能

**买家端**：分类浏览、卡带式商品卡（支持商品配图，无图自动生成字标）、下单锁库存（防超卖）、15 分钟支付倒计时、支付状态自动轮询跳转、卡密「撕开封条查看」+ 一键复制、订单查询找回卡密、暗/亮双主题切换。
...
> 上面几张截图拍摄于旧版「票据」界面，现已改版为卡带设计语言，待重拍。
